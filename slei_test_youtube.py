...
class TestYTapp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.yt = AppYoutube()
        self.videomock = Mock(Id = 5, Nombre = "Zelda Medley", Duracion = "PT3M37S", Canal = "Melodica Men",  Fecha= "2018-03-05T15:59:48.000Z", Likes = self.yt.InfoVideo("https://www.youtube.com/watch?v=j2KonMkk6To").Likes, Vistas = self.yt.InfoVideo("https://www.youtube.com/watch?v=j2KonMkk6To").Vistas, Descripcion = "Get your melodica at www.melodicamen.com!\n\nLove what we do? Support us on Patreon! https://www.patreon.com/melodicamen")
